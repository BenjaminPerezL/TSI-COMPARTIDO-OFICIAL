        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            @foreach ($eventos as $ev)
                <tr>
                    ...
                    <td>
                        {{substr($ev->descripcion,0,strpos($ev->descripcion,"-"))}}
                    </td>
                    <td>
                        {{substr($ev->descripcion,strpos($ev->descripcion,"-")+1)}}
                    </td>  
                    <td class="text-center" style="width: 1rem">
                    ...
                    <td class="text-center" style="width: 1rem">
                        <a href="" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Editar Cliente">
                            <i class="far fa-edit"></i>
                        </a>
                    </td>
                </tr>
                ...
                <div class="card-body">
                    ...
                    <select name="tipo_servicio" id="tipo_servicio" >
                      <optgroup label="Servicios disponibles">
                        ...
                        <div class="form-group">
                            <label for="hora">Hora: </label>
                            <input type="time" id ="txtHora" name="txtHora" class="form-control" value="">
                        </div>
                        <div class="form-group">
                            <label for="descripcion">Descripcion: </label>
                            <input type="text" id = "descripcion" name="descripcion" class="form-control">
                        ...
                        <div class="form-group">
                            <button class="btn btn-info" type="" id="btnAceptar">Aceptar</button>
